...
____
### _Please note that the Brazilian National Institute for Industrial Property ([INPI](http://www.inpi.gov.br/)) has defined the rights and distribution of this software (Process: BR512016000508-4). Please contact [Juan Villada](mailto:juan.arteaga@ufv.br) if you are interested in the CodG scripts for academic research. Please do your request using an institutional e-mail._
____
